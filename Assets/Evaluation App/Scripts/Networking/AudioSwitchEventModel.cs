...
[RealtimeModel]
public partial class AudioSwitchEventModel
{
...
public partial class AudioSwitchEventModel : RealtimeModel
{
    ...
    public delegate void PropertyChangedHandler<in T>(AudioSwitchEventModel model, T value);
    ...
    public AudioSwitchEventModel() : base(null)
    {
